...
pub struct SearchSettings {
    ...
    pub blocked_result_domains: Vec<String>,
}
...
impl Default for SearchSettings {
    fn default() -> Self {
        Self {
            ...
            blocked_result_domains: vec!["9gag.com".to_string()],
        }
    }
}
...
impl Settings {
    pub fn runtime_warnings(&self) -> Vec<String> {
        ...
        {
            warnings.push("search.blocked_result_domains contains an empty domain entry.".to_string());
        }
